rec {
  shellHook-for = { package, pythoneda-base, python, nixpkgsRelease }: ''
    ...
    echo -e " \033[32m| '_ \| | | | __| '_ \ / _ \| '_ \ \033[34m/ _ \\\\\033[35m/ _\` |\033[36m/ _\` |\033[33mhttps://github.com/pythoneda-artifact-event/git-tagging/tree/$PVERSION\033[0m";
    echo -e " \033[32m| |_) | |_| | |_| | | | (_) | | | |\033[34m  __/\033[35m (_| |\033[36m (_| |\033[34mhttps://github.com/pythoneda-artifact/git-tagging\033[0m";
    ...
    echo -e " \033[32m|_| \033[31mE\033[36mA\033[32m |___/           \033[33mGIT-TAGGING EVENTS           \033[37mhttps://patreon.com/rydnr\033[0m";
    echo;
    echo " Thank you for using pythoneda-artifact-event/git-tagging, PythonEDA in general, and for your appreciation of free software.";
    echo;
